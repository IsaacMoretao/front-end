...
export function Navigation() {
  ...
  return (
    <>
      <main
        className={`flex justify-center items-center gap-5 lg:ml-16 min-h-[95vh]  ${darkMode ? "bg-gray-900" : "bg-white"
          }`}
      >
        {state.level === "ADMIN" ? (
          <a href={`${state.aceesAdmin}`} target="_blank" rel="noopener noreferrer">
